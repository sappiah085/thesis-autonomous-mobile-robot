...
class OccupancyGrid:
    ...
    def update_from_scan(self, robot_x: float, robot_y: float, robot_theta: float,
        ...
        # Decay existing occupancy (forgetting factor)
        self.grid *= 0.95
